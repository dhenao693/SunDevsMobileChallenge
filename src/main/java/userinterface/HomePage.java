...
public class HomePage {
    ...
    public static final Target BTN_TODAY = Target.the("Menu Options")
            .located(accessibilityId("HOY"));
    public static final Target BTN_MOVIE_TIME = Target.the("Menu Options")
            .located(xpath("//android.view.View[contains(@content-desc,'14:30')]"));
    ...
    public static final Target LBL_LOCATION_IN_ROOM = Target.the("")
            .located(accessibilityId("Ubicación en sala"));




    public static final Target BTN_SELECT_SEAT_POSITION = Target.the("")
            .located(xpath(
