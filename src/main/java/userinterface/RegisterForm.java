...
public class RegisterForm {
    ...
    public static final Target LBL_LASTNAME = Target.the("")
            .located(accessibilityId("//android.widget.ScrollView/android.widget.EditText[2]"));
    public static final Target LBL_EMAIL = Target.the("")
            .located(accessibilityId("//android.widget.ScrollView/android.widget.EditText[3]"));
    public static final Target LBL_RETRY_EMAIL = Target.the("")
            .located(accessibilityId("//android.widget.ScrollView/android.widget.EditText[4]"));
    public static final Target LBL_PHONE = Target.the("")
            .located(accessibilityId("//android.widget.ScrollView/android.widget.EditText[5]"));
